const recommendations = {
  sun: {
    title: "AT0070 คือคำตอบที่สมดุลสุดสำหรับกันแดด/UV",
    body: "ได้ UPF50+, หน้าร่ม 24 นิ้ว/106 ซม. และน้ำหนักราว 250 กรัม จึงบังได้กว้างกว่า AT0060 แต่ยังเบากว่า AT0068 มาก",
